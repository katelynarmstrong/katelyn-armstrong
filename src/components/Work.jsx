...
import tacoBellThrowdown from '../assets/tacoBellThrowdown.png'

const Work = () => {
  return (
    <div name='work' className='w-full md:h-screen text-gray-300 bg-[#827081]'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div className='pb-8'>
          <p className='text-4xl font-bold inline border-b-4 text-gray-300 border-[#e61f93]'>
            Work
          </p>
          <p className='py-6'>Here are some of my recent works that i am proud of.
          More available upon request.</p>
        </div>
...
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          >
            ...
            {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${dreamTeam})` }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100'>
          ...
          <div
            style={{ backgroundImage: `url(${horrorscopes})` }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100'>
            ...
            {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${lettuceTalk})` }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100'>
          ...
          <div
            style={{ backgroundImage: `url(${tacoBellThrowdown})` }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                ...
                <a href='https://github.com/joshlyons225/taco-bell-throwdown' target={'_blank'}>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
